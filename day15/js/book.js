...
// console.log(bookList[0]);                // title, author, price 모두 출력
// console.log(bookList[0].title);             // title만 출력
// console.log(bookList[0].author);

document.write("<h2>책 제목으로 살펴보기</h2>")
/*
for(let i = 0; i <bookList.length; i++){
    document.write("<p>" + bookList[i].title);              // title만 모두 출력
}
*/
for(let i in bookList)
    document.write("<p>" + bookList[i].title);              // 둘다 가능